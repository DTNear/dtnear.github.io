  ...
  return (
    <>
      ...
      <main className="padding-x max-width pt-6 lg:px-20">
        ...
        <div>
          <a
            href="https://www.paypal.com/de/home " target="_blank"
            className="outline-btn-color inline-block rounded-full py-2 px-4 text-lg font-semibold animate-bounce shadow-xl"
          >
            Donate
          </a>
        </div>
